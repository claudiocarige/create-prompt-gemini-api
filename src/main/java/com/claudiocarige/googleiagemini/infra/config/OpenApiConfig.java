...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Criador de prompt para buscas com o Gemini")
                        .version("v1")
                        .description("Esta API irá te ajuadar a construir um prompt para ser usado em uma iteração com o Gemini IA" +
